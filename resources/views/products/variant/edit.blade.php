            ...
            <form class="card shadow mb-5" action="{{ route('product-variant.update', $product_variant) }}" method="post">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" name="title" value="{{ old('title') ?: $product_variant->title }}"
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description" id="" cols="30" rows="3"
                                  class="form-control @error('description') is-invalid @enderror">{{ old('description') ?: $product_variant->description }}</textarea>
                        @error('description')
                        <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
                        @enderror
                    </div>
